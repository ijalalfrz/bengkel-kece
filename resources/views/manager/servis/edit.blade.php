...
<div class="main-content container-fluid">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <form method="POST" action="{{ url('/manager/servis/'.$servis->id) }}" >
        @csrf
        <input type="hidden" name="_method" value="PUT">
        <div class="form-group">
          <label>Nama</label>
          <input type="text" name="nama" class="form-control" required value="{{ $servis->nama}}">
        </div>
        <div class="form-group">
          <label>Harga Jasa</label>
          <input type="number" name="harga_jual" class="form-control" required value="{{ (int)$servis->harga_jual}}">
        </div>
        <p class="text-right">
